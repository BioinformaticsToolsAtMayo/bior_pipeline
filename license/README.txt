This directory contains all license information from the dependent projects that BioR uses.  A complete listing of these projects and the license used in in deps.txt.  

BioR is licensed under the Mayo License.
This includes bior_catalog, bior_pipeline, and mayo pipes.


 Terms of Use:

Mayo Foundation and Medical Education and Research (MFMER), has created BioR software that provides annotation for genomic variants  ("Software").
