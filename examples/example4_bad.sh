...
cat example.vcf \
| bior_vcf_to_tjson --log \
| bior_same_variant --log  -d $BIOR_CATALOG/1000_genomes/20110521/ALL.wgs.phase1_release_v3.20101123.snps_indels_sv.sites_GRCh37.tsv.bgz \
| bior_drill --log -p AF -p AFR_AF
# | cut --complement -f 9 \
# > out4.tsv
