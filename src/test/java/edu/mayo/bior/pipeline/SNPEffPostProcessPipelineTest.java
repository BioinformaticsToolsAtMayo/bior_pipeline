...
public class SNPEffPostProcessPipelineTest {
	...
	public void testPipeline_mostSignificantEffect() throws Exception {
		...
		String inputLine = "chr1\t949608\trs1921\tG\tA\t0.0\t.\tEFF=NON_SYNONYMOUS_CODING(MODERATE|MISSENSE|aGc/aAc|S83N|ISG15|protein_coding|CODING|ENST00000379389|exon_1_949364_949920),UPSTREAM(MODIFIER||||RP11-54O7.11|antisense|NON_CODING|ENST00000458555|)"; 
        ...
        p.setStarts(Arrays.asList(inputLine));
