...
public class VEPPostProcessingPipelineTest {
    ...
    public void testGetWorstPipeline(){
        ...
        VEPPostProcessingPipeline vepp = new VEPPostProcessingPipeline("WorstScenario");
        Pipe p;
        // Only return those lines that have a worst case (and so must have some scores to compare)
        // (if there were no scores, then the VEP JSON element will be empty, and therefore we will skip it)
        Pipe testP = new Pipeline(new GrepPipe(".*\\{.+}.*"),
                                  //new PrintPipe()
                                  new IdentityPipe()
                );
        p = vepp.getPipeline(new CatPipe(), testP, true);
        ...
        List<String> expected = Arrays.asList(
        		"17	41197702	rs80357183	T	A	.	.	.	{\"Allele\":\"A\",\"Gene\":\"ENSG00000012048\",\"Feature\":\"ENST00000491747\",\"Feature_type\":\"Transcript\",\"Consequence\":\"missense_variant\",\"cDNA_position\":\"2372\",\"CDS_position\":\"2273\",\"Protein_position\":\"758\",\"Amino_acids\":\"H/L\",\"Codons\":\"cAc/cTc\",\"HGNC\":\"BRCA1\",\"SIFT\":\"deleterious(0)\",\"PolyPhen\":\"probably_damaging(0.952)\",\"SIFT_TERM\":\"deleterious\",\"SIFT_Score\":0.0,\"PolyPhen_TERM\":\"probably_damaging\",\"PolyPhen_Score\":0.952}",
        		"17	41197708	rs201196020	T	G	.	.	.	{\"Allele\":\"G\",\"Gene\":\"ENSG00000012048\",\"Feature\":\"ENST00000591534\",\"Feature_type\":\"Transcript\",\"Consequence\":\"missense_variant\",\"cDNA_position\":\"1154\",\"CDS_position\":\"1052\",\"Protein_position\":\"351\",\"Amino_acids\":\"H/P\",\"Codons\":\"cAc/cCc\",\"HGNC\":\"BRCA1\",\"SIFT\":\"tolerated(0.23)\",\"PolyPhen\":\"possibly_damaging(0.744)\",\"SIFT_TERM\":\"tolerated\",\"SIFT_Score\":0.23,\"PolyPhen_TERM\":\"possibly_damaging\",\"PolyPhen_Score\":0.744}",
        		"17	41197711	rs80357322	G	C	.	.	.	{\"Allele\":\"C\",\"Gene\":\"ENSG00000012048\",\"Feature\":\"ENST00000352993\",\"Feature_type\":\"Transcript\",\"Consequence\":\"missense_variant\",\"cDNA_position\":\"2382\",\"CDS_position\":\"2150\",\"Protein_position\":\"717\",\"Amino_acids\":\"P/R\",\"Codons\":\"cCc/cGc\",\"HGNC\":\"BRCA1\",\"SIFT\":\"deleterious(0)\",\"PolyPhen\":\"probably_damaging(0.964)\",\"SIFT_TERM\":\"deleterious\",\"SIFT_Score\":0.0,\"PolyPhen_TERM\":\"probably_damaging\",\"PolyPhen_Score\":0.964}"
        		);
    	...
    	// There were 2782 lines in the original file, but only 607 had scores that we could pick a worst-case from
    	assertEquals(607, actual.size());
    	// Only compare the first 3 lines though
        PipeTestUtils.assertListsEqual(expected, actual.subList(0,3));
    }
    
    @Test
    public void testGetWorstPipeline2() throws IOException{
        ...
        List<String> actual = PipeTestUtils.getResults(p);
        List<String> expected = FileCompareUtils.loadFile("src/test/resources/tools/vep/example.vcf.vep.drill");
    ...
    public void testFanout() throws IOException {
    	System.out.println("VEPPostProcessingPipeline.fanout() ....");
        VEPPostProcessingPipeline vepp = new VEPPostProcessingPipeline("Cartesian");
        Pipe vepPipe = vepp.getPipeline(
        		new CatPipe(), 
        		new IdentityPipe(), //new Pipeline(new GrepPipe(".*\\{.+}.*"), new IdentityPipe()),
                true
                );
        vepPipe.setStarts(Arrays.asList("src/test/resources/tools/vep/vepsample.expected.mid.vcf"));
    	List<String> actual = PipeTestUtils.getResults(vepPipe);

    	List<String> expected = FileCompareUtils.loadFile("src/test/resources/tools/vep/vepsample.expected.fanout.vcf");
